...
**Tests**: The examples below include test tasks. Ensure tests are written and failing before implementation if following TDD.
...
- [ ] T018 [P] [US2] Contract test for [endpoint] in tests/contract/test_[name]
- [ ] T019 [P] [US2] Integration test for [user journey] in tests/integration/test_[name]
...
- [ ] T024 [P] [US3] Contract test for [endpoint] in tests/contract/test_[name]
- [ ] T025 [P] [US3] Integration test for [user journey] in tests/integration/test_[name]

### Implementation for User Story 3

- [ ] T026 [P] [US3] Create [Entity] model in src/models/[entity]
- [ ] T027 [US3] Implement [Service] in src/services/[service]
- [ ] T028 [US3] Implement [endpoint/feature] in src/[location]/[file]
...
- [ ] TXXX [P] Additional unit tests and verify quality gates pass
