...
此命令将默认的 Spec 模板复制到当前项目的 `sdd/templates/spec-template.md`，并允许用户根据需要进行修改。
...
2. **复制模板**:
   - 将 `$WAVE_PLUGIN_ROOT/templates/spec-template.md` 复制到当前项目的 `sdd/templates/spec-template.md`。
   - 如果目标文件已存在，询问用户是否覆盖。
