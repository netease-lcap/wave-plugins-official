...
- **领域服务-逻辑-获取用户表格视图**：plan/backend/logic-LcapGetUserTableView.md
- **领域服务-逻辑-创建普通用户**：plan/backend/logic-LcapCreateNormalUser.md
- **领域服务-逻辑-更新普通用户**：plan/backend/logic-LcapUpdateNormalUser.md
- **领域服务-逻辑-获取用户名列表**：plan/backend/logic-LcapGetUserNameList.md
- **领域服务-逻辑-加载用户管理直属主管选择列表**：plan/backend/logic-LcapLoadUserManagementSelect.md
- **领域服务-逻辑-根据用户ID获取用户名**：plan/backend/logic-LcapGetUserNameByUserId.md
