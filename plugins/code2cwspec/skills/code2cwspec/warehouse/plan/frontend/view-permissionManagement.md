...
- **领域服务-逻辑-加载权限管理表格视图数据**：plan/backend/logic-LcapLoadPermissionManagementTableView.md
- **领域服务-逻辑-获取权限名称列表**：plan/backend/logic-LcapGetPermissionNameList.md
- **领域服务-逻辑-获取未关联的权限资源列表**：plan/backend/logic-LcapGetPermissionResourseNotRelated.md
- **领域服务-逻辑-获取权限已关联资源列表**：plan/backend/logic-LcapGetPermissionResourceRelated.md
- **领域服务-逻辑-根据权限ID获取权限资源映射列表**：plan/backend/logic-LcapGetPerResMappingByPermissionId.md
