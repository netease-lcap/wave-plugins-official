...
- **领域服务-逻辑-加载角色管理表格视图数据**：plan/backend/logic-LcapLoadRoleManagementTableView.md
- **领域服务-逻辑-根据角色ID获取权限**：plan/backend/logic-LcapGetPermissionByRoleId.md
- **领域服务-逻辑-获取用户资源**：plan/backend/logic-LcapGetUserResources.md
- **领域服务-逻辑-加载用户角色映射表格视图数据**：plan/backend/logic-LcapLoadUserRoleMappingTableView.md
- **领域服务-逻辑-根据角色与权限关系删除映射**：plan/backend/logic-LcapGetMappingDeleteByRoleIdAndPermissionId.md
- **领域服务-逻辑-加载角色可添加权限列表**：plan/backend/logic-LcapLoadAddRolePermissionTableView.md
- **领域服务-逻辑-加载角色可添加用户列表**：plan/backend/logic-LcapLoadAddRoleUserTableView.md
- **领域服务-逻辑-获取角色名称列表**：plan/backend/logic-LcapGetRoleNameList.md
- **领域服务-逻辑-根据用户ID列表获取用户信息**：plan/backend/logic-LcapGetUserByUserIds.md
