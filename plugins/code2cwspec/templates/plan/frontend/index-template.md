...
<!-- 功能页面英文名称严格使用 camelCase 格式 -->
<!-- 严格按照 功能模块目录 的 **页面** 功能点生成 功能页面 与 层级路由，必须忽略 **逻辑** 功能点。以下所有功能页面必须要生成对应关联文档，禁止遗漏或伪造任何功能页面 -->
...
<!-- 功能页面英文名称必须与层级路由中的路径的最后一级一致，禁止同一个功能页面的英文名称与层级路由的路径的最后一级不一致 -->
